...
if len(dfs_kazan_sales[col_name_of_kazan_product]):
    ...
    st.warning(f'Данные о продажах {product_of_kazan} в г. Казань отсутствуют, либо продаж этого товара в \
    указанных сетях в Январе 2023 г. не было.')
...
if len(temp_df_for_shops_around):
    ...
    st.warning(f'Данные о продажах {product_of_shop} в г. Казань отсутствуют, либо продаж этого товара в \
    указанных сетях в Январе 2023 г. не было.')
